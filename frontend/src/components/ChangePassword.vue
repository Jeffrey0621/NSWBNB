    ...
    <a-spin :spinning="spinning" tip="Loading...">
      ...
      <div>
        ...
        <div style="float:left;text-align: left;width: 60%">
          <input class="text-right" name="oldPassword" type="password" v-model="oldPassword"
      ...
      <div>
        ...
        <div style="float:left;text-align: left;width: 60%">
          <input class="text-right" name="newPassword" type="password" v-model="newPassword"
                 v-validate="{'required':'true','min':8}"></input>
        </div>
        <div style="clear: left"></div>
        <div style="width: 30%;float: left;text-align: right;">
          <p></p>
      ...
      <div>
        ...
        <div style="float:left;text-align: left;width: 60%">
          <input class="text-right" type="password" name="confirmPassword" v-model="confirmPassword"
                 v-validate="{'required':'true','is':newPassword}"></input>
        </div>
        <div style="clear: left"></div>
        <div style="width: 30%;float: left;text-align: right;">
          <p></p>
